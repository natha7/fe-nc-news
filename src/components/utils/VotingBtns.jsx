...
export default function VotingBtns(props) {
  ...
  return (
    <div className="flex flex-row [&>div]:border shadow-sm">
      {hasVoteFailed ? <p>Something went wrong, please try again</p> : null}
      <div>
        <button
          className="group w-10 flex flex-col items-center m-1"
          onClick={changeLikes}
          value="like"
        >
          {isLikeBtnPressed ? (
          ...
          <p className="group-hover:underline pointer-events-none text-xs text-emerald-800">
            Like
          </p>
        </button>
      </div>
